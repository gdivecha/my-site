...
export function CopyIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} {...props}>
      ...
      <path d="M15.5 8.5V6.2A2.2 2.2 0 0 0 13.3 4H5.7a2.2 2.2 0 0 0-2.2 2.2v7.6a2.2 2.2 0 0 0 2.2 2.2h2.8" strokeLinecap="round" />
    </svg>
  );
}
...
export function SwapIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} {...props}>
      <path d="M4 8h13m0 0-4-4m4 4-4 4" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M20 16H7m0 0 4 4m-4-4 4-4" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
export function StackedRowsIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} {...props}>
      ...
      <rect x="3.5" y="10.5" width="17" height="4.5" rx="1.3" />
      <rect x="3.5" y="16.5" width="17" height="4.5" rx="1.3" />
    </svg>
  );
}
