...
export function SkillRow({ category }: { category: SkillCategory }) {
  ...
  return (
    <div
      className="rounded-2xl border border-line bg-transparent px-6 py-4 backdrop-blur-[3.8px] transition-colors hover:bg-panel-alt/20"
    ...
    >
      ...
      >
        <div className={hovered ? "overflow-visible" : "overflow-hidden"}>
