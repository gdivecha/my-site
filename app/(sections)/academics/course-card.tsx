...
export function CourseCard({ course }: { course: Course }) {
  ...
  return (
    <button
      ...
      onClick={() => setOpen((o) => !o)}
      aria-pressed={open}
      className="flex h-36 w-full flex-col items-start gap-2 overflow-hidden rounded-2xl border border-line bg-card-tint p-4 text-left backdrop-blur-[3.8px] transition-colors duration-300 ease-out hover:bg-card-tint-hover"
    >
